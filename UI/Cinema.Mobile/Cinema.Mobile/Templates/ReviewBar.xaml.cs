...
namespace Cinema.Mobile.Templates
{
    [XamlCompilation(XamlCompilationOptions.Compile)]
    public partial class ReviewBar : ContentView
    {
        ...
        public ReviewBar()
        {
            ...
            #endregion
            stackReviewBar.Children.Add(star1);
            stackReviewBar.Children.Add(star2);
            stackReviewBar.Children.Add(star3);
            stackReviewBar.Children.Add(star4);
            stackReviewBar.Children.Add(star5);
            ...
            stackReviewBar.GestureRecognizers.Add(panGesture);
        }
        ...
        declaringType: typeof(ReviewBar),
        ...
        {
            var control = (ReviewBar)bindable;
            control.stackReviewBar.HorizontalOptions = (LayoutOptions)newValue;
        }
        ...
        {
            var control = (ReviewBar)bindable;
            control.stackReviewBar.VerticalOptions = (LayoutOptions)newValue;
        }
        #endregion
